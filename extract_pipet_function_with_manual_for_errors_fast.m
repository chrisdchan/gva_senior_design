function extract_pipet_function_with_manual_for_errors_fast(activeDir,nImgsPerFOV,wellsPerRow,channelL,assayVol,pathDir,toRotate,colorIm,pixSz,wellsPerFOV)
...
imgFB = zeros(ysize*imgResize,xsize*imgResize,nFOV);
for nn = 1:nFOV
