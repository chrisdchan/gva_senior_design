function [apY,apX,CFUs,clicked_points,app,radiiOut,bound_mask] = pipetteSegmenter_withMax_fast_while_aquiring(im,activeDir,CFUs,clicked_points,...
...
%save('tmp_seg.mat','im','activeDir','CFUs','clicked_points','currZoom','modelNum','ax','channelL','assayVol','dilutionFactor','collList','rr','nn','wll','nWells','nRows','collStart','collBtm','collAngle','app','pixSz','bound_mask','maxCol','fudgeFactor','inBkgrnd');
%error('BREAK')
